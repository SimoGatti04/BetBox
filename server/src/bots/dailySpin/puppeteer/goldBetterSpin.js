const { delay, simulateHumanBehavior, smoothMouseMove, simulateTyping,
  setupBrowser, getSessionFile } = require('../../../utils/puppeteer/botUtils');
const { goldBetterLogin, acceptGoldBetterCookies,
  extractBonusValue, extractBonusType } = require('../../../utils/puppeteer/goldBetterUtils');
