...
async function getGoldBetterActiveBets(site) {
    return getActiveBets(site, {
        ...
        selectTimePeriod: async (page) => {
            await page.waitForSelector("//mat-form-field[.//mat-label[contains(text(), 'Tipologia')]]//mat-select");
            await page.click("//mat-form-field[.//mat-label[contains(text(), 'Tipologia')]]//mat-select");
            await page.waitForSelector('mat-option:has-text("Sport")');
            await page.click('mat-option:has-text("Sport")');
